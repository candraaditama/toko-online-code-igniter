	...
	<div class="col-md-4">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
			...
			echo form_open(base_url(akses().'/laporan/penjualan/periode'),array('class'=>'form-horizontal','target'=>'_blank'));
			?>
	...
	<div class="col-md-4">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <?php
			echo validation_errors();
			echo form_open(base_url(akses().'/laporan/penjualan/bulanan'),array('class'=>'form-horizontal','target'=>'_blank'));
			?>
			<div class="form-group">
	...
	<div class="col-md-6">
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		    <?php
			echo validation_errors();
			echo form_open(base_url(akses().'/laporan/penjualan/produk'),array('class'=>'form-horizontal','target'=>'_blank'));
			?>
			<div class="form-group">
