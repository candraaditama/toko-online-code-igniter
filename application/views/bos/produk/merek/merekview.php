		...
		<tbody>
			...
			if(!empty($data))
			{
				...
				<tr>
					...
					<td>
						<a href="<?=base_url(akses().'/produk/merek/edit').'?id='.$id;?>" class="btn btn-md btn-info"><i class="fa fa-pencil"></i></a>
						<a onclick="return confirm('Yakin ingin menghapus Merek ini?');" href="<?=base_url(akses().'/produk/merek/delete').'?id='.$id;?>" class="btn btn-md btn-danger"><i class="fa fa-trash"></i></a>
					</td>
				</tr>
				<?php
				}
