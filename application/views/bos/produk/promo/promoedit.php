...
<div class="form-group">
	...
	<div class="col-md-6">
		<p class="form-control-static"><?=$row->kode;?></p>
	</div>
</div>
<div class="form-group">
...
<div class="col-md-4">
	...
	<div class="form-group">
		...
		<div class="col-md-5">
			<input type="number" name="jumlah" id="" class="form-control " autocomplete="off" placeholder="Jumlah Kupon" required="" value="<?php echo set_value('jumlah',$row->jumlah); ?>"/>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label" for="">Min. Order</label>
		<div class="col-md-10">
			<input type="text" name="minimal" id="" class="form-control duit" autocomplete="off" placeholder="Minimal Order" required="" value="<?php echo set_value('minimal',$row->minimal_order); ?>"/>
		</div>
	</div>
	<div class="form-group">
