		...
		<tbody>
			...
			if(!empty($data))
			{
				...
				<tr>
					...
					<td>
						<a href="<?=base_url(akses().'/cms/kategori/edit?id='.$id);?>" class="btn btn-flat btn-md btn-info"><i class="fa fa-pencil"></i> Edit</a>
					<a onclick="return confirm('Yakin ingin menghapus kategori <?=$row->nama_kategori;?> ?');" href="<?=base_url(akses().'/cms/kategori/delete?id='.$id);?>" class="btn btn-flat btn-md btn-danger"><i class="fa fa-trash"></i> Delete</a>
					</td>
				</tr>
				<?php
				}
