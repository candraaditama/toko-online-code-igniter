	...
	<tbody>
		...
		if(!empty($data))
		{
			...
			<tr>
				...
				<td><?=$user;?></td>
				<td>
					<a href="<?=base_url(akses().'/cms/berita/edit?id='.$id);?>" class="btn btn-flat btn-md btn-info"><i class="fa fa-pencil"></i> Edit</a>
					<a onclick="return confirm('Yakin ingin menghapus berita ini?');" href="<?=base_url(akses().'/cms/berita/delete?id='.$id);?>" class="btn btn-flat btn-md btn-danger"><i class="fa fa-trash"></i> Delete</a>
				</td>
			</tr>
			<?php
			}
